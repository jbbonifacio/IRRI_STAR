...
# Modified by: Alaine A. Gulles 09.25.2013
# Note: include 
# --------------------------------------------------------------------------------------

Crosstab <- function(data, rowVar, colVar, freqVar = NULL, obsFreq = TRUE, expFreq = FALSE, stdresid = FALSE, totPercent = FALSE, rowPercent = FALSE, colPercent = FALSE, chisq = FALSE, phi = FALSE, cramersv = FALSE, contingency = FALSE) UseMethod("Crosstab")

Crosstab.default <- function(data, rowVar, colVar, freqVar = NULL, obsFreq = TRUE, expFreq = FALSE, stdresid = FALSE, totPercent = FALSE, rowPercent = FALSE, colPercent = FALSE, chisq = FALSE, phi = FALSE, cramersv = FALSE, contingency = FALSE) {
