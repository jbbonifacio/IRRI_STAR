...
#     ClusterDivisive <- function(data, var, idVar, sbinVar, abinVar, ofactorVar, factorVar, stand= TRUE, distance, distMatrix, clusterMem, descriptiveStatRaw,corMatx,scatterMatx,descriptiveStat, dendrogram, clusterBox, clusterNum)  
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
...
ClusterDivisive <- function(data, var = NULL, idVar =NULL,sbinVar = NULL, abinVar = NULL, ofactorVar = NULL, factorVar = NULL, stand = TRUE, 
                            distance = c("Euclidean", "Maximum", "Manhattan", "Minkowski", "Canberra", "Binary", "Simple Matching","Sokal & Sneath", "Hamann coefficient", "Jaccard", "Dice", "Gower"),
				                    distMatrix = FALSE,copDistance = FALSE, clusterMem = TRUE, descriptiveStatRaw = TRUE, corMatx = TRUE, scatterMatx = TRUE, descriptiveStat = TRUE, dendrogram = TRUE, clusterBox = TRUE, 
